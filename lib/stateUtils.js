...
async function setTargetTemperatureFromRaw(device, raw) {
...
function setTargetTemperatureToRaw(device) {
  ...
  if (targetTemperature < Constants.MinTemperatureNot8C && targetAcMode !== Constants.Heat) {
    targetTemperature = Constants.MinTemperatureNot8C;
  }
...
function setMeritAToRaw(device) {
  let targetMeritA = device.getCapabilityValue(Constants.CapabilityTargetMeritA);
  // if targetTemperature < 16, set to Heating_8C
  if (device.getCapabilityValue(Constants.CapabilityTargetTemperatureInside) < Constants.MinTemperatureNot8C) {
