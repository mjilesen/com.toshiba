...
module.exports = class ToshibaHttpApi extends SimpleClass {
    ...
    this.params = "";
    this.header = "";
    this.deviceID = this.homey.settings.get( "DeviceID");
  ...
  async getACs() {
    ...
    group.ACList.forEach((ac, i) => {
      ...
      acs.push({
          ...
          tore:{ State: ac.ACStateData,
                 OriginalState: ac.ACStateData }
        });
      });
    });
  ...
  async login( username, password){
    ...
    if ( success ){
      ...
      this.homey.settings.set( "TokenInformation", this.token_information )
