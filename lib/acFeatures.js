...
exports.setCapabilities = async device => {
  ...
  const meritBit0 = Boolean(meritFeatureBitString.substring(0, 1));
  const meritBit1 = Boolean(meritFeatureBitString.substring(1, 2));
  const meritBit2 = Boolean(meritFeatureBitString.substring(2, 3));
  const meritBit3 = Boolean(meritFeatureBitString.substring(3, 4));
  const meritBit4 = Boolean(meritFeatureBitString.substring(4, 5));
  const meritBit5 = Boolean(meritFeatureBitString.substring(5, 6));
  const meritBit6 = Boolean(meritFeatureBitString.substring(6, 7));
  const meritBit7 = Boolean(meritFeatureBitString.substring(7, 8));
  const meritBit14 = Boolean(meritFeatureBitString.substring(14, 15));
  const meritBit15 = Boolean(meritFeatureBitString.substring(15));
